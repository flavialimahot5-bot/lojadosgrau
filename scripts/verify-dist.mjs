...
for (const file of ['index.html','mobile.html','catalogo.html','produto.html','favoritos.html','carrinho.html','commerce.js','original-product.js','data/card-template.json']) requireFile(file, 'Aplicação');
